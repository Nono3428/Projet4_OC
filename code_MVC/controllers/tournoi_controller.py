...
class TournoiController:
    ...
    def demarrer_tournoi(self, tournoi, joueur_controller):
        if len(tournoi.joueurs) >= 6:
            ...
            Rapport.afficher_message("Il n'y a pas asser de participants pour le tournoi. "
                                     "Minimum de 6 participants pour lancer le tournoi.")
            ...
            while True:
                try:
                    resultat = IntPrompt.ask(f"[yellow]Qui est le vainqueur pour ce match ?[/yellow]\n"
                                             f"(1 = {joueur1.nom}, 2 = {joueur2.nom}, 0 = Match nul)")
                    ...
                    if resultat == 1:
                        ...
                        console.print(f"[green]{joueur1.nom} {joueur1.prenom} gagne contre {joueur2.nom}"
                                      f"{joueur2.prenom}[/green]")
                    elif resultat == 2:
                        ...
                        console.print(f"[green]{joueur2.nom} {joueur2.prenom} gagne contre {joueur1.nom}"
                                      f"{joueur1.prenom}[/green]")
                    else:  # Match nul
                        ...
                        console.print(f"[blue]Match nul entre {joueur1.nom} {joueur1.prenom} et {joueur2.nom}"
                                      f"{joueur2.prenom}[/blue]")
                    ...
                    console.print("[red]Entrée invalide. Veuillez entrer 1 pour le joueur 1, 2 pour le joueur 2, "
                                  "ou 0 pour match nul.[/red]")
